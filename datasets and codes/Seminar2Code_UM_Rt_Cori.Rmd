...
*read data*
```{r}
normalized_um_rt_cori = read.csv(file="datasets/normalized_data_um_rt_cori.csv")
rownames(normalized_um_rt_cori) = normalized_um_rt_cori$KabupatenKota
normalized_um_rt_cori$KabupatenKota = NULL
```
...
```{r}
clean_data = read.csv(file = "datasets/clean_data_um_rt_cori.csv")
...
```{r}
Revised_data_gerombol = read.csv("datasets/clean_data_um_rt_cori.csv")
...
leaflet(Revised_data_gerombol) %>%
  ...
  addLabelOnlyMarkers(data = pikobar_df,
                    ...
                    labelOptions = labelOptions(noHide = TRUE, direction = 'top', textOnly = TRUE,style = list("color" = "white", 
                                  ...
                                  "font-style" = "normal",
                                  "font-size" = "12px" ))) %>%
 addLabelOnlyMarkers(108.379537, -6.009965, label =  "Data UM_Cori_Penting", 
